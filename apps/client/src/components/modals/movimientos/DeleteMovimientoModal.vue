  ...
  <v-dialog v-model="dialog" max-width="500px">
    <v-card>
      ...
      <v-card-text class="pt-4">
        ...
        <v-card v-if="movimiento" class="pa-2 mb-4" variant="outlined">
        ...
        <v-alert class="mb-0" density="compact" type="error" variant="tonal">
      ...
      <v-card-actions>
        ...
        <v-btn color="error" :loading="loading" variant="elevated" @click="confirmDelete">Eliminar</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
</template>
