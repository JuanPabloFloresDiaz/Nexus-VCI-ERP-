    ...
    <v-card class="rounded-lg" elevation="2" width="600">
      <v-card-item class="bg-primary text-white py-4">
        <template #prepend>
          <v-avatar color="white" size="64">
            ...
            />
            <span v-else class="text-h4 text-primary font-weight-bold">
      ...
      <v-list class="py-0">
        <v-list-item class="py-4">
          <template #prepend>
            <v-icon class="mr-4" color="primary">mdi-account</v-icon>
          </template>
        ...
        <v-list-item class="py-4">
          <template #prepend>
            <v-icon class="mr-4" color="primary">mdi-email</v-icon>
          </template>
