        ...
        <v-card v-if="pedido">
            ...
            <v-card-text class="pa-4 bg-grey-lighten-5">
                ...
                <v-card elevation="1">
                    ...
                    <v-table density="compact">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3" class="text-right font-weight-bold text-h6 pt-4">TOTAL</td>
            ...
            <v-card-actions class="pa-4 bg-white">
                ...
                <!-- Add Print Button maybe? -->
                 <v-btn color="secondary" variant="flat" prepend-icon="mdi-printer" class="ml-2">Imprimir</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
